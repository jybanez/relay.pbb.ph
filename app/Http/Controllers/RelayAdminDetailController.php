    ...
    public function messageData(HubRelayMessage $message): JsonResponse
    {
        ...
        return response()->json($this->detailPayload(
            ...
            [
                ...
                ['label' => 'Target Systems', 'value' => collect($message->target_systems ?? [])->implode(', ') ?: 'None'],
                ['label' => 'Next Hops', 'value' => collect($message->target_hub_ids ?? [])->implode(', ') ?: 'None'],
    ...
    public function deliveryData(HubRelayDelivery $delivery): JsonResponse
    {
        ...
        return response()->json($this->detailPayload(
            ...
            [
                ...
                ['label' => 'Target Systems', 'value' => collect($delivery->message?->target_systems ?? [])->implode(', ') ?: 'None'],
